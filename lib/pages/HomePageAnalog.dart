...
class HomePageAnalog extends StatefulWidget {
  @override
  _HomePageAnalogState createState() => _HomePageAnalogState();
}

class _HomePageAnalogState extends State<HomePageAnalog> with WidgetsBindingObserver{
  int temperature;
  String _Term;
  ...
  void updateDisplayInfo() async {
    ...
    setState(() {
      temperature =
          ((weatherData.currentTemperature - 273.15) * 9 / 5 + 32).round();
...
class _IconBoxState extends State<IconBox> with TickerProviderStateMixin{
  ...
  @override
  Widget build(BuildContext context) {
    double delta = ((MediaQuery.of(context).size.height - 230) * 0.20);
    double temperatureMaxScreen =
        (((MediaQuery.of(context).size.height - 230) * 0.55));
    double tempScreen =
        (widget.temperature / temperatureMax) * temperatureMaxScreen + delta;

    if (tempScreen > (MediaQuery.of(context).size.height - 230) * 0.85) {
      tempScreen = ((MediaQuery.of(context).size.height - 230) * 0.85);
    }
    //
    if (tempScreen < ((MediaQuery.of(context).size.height - 230) * 0.18)) {
      tempScreen = ((MediaQuery.of(context).size.height - 230) * 0.18);
    }
    return Container(
                ...
                children: [
                  ...
                  Center(
                    child: Container(
                      ...
                      child: Container(
                        child: Image.asset("assets/images/gr8.png"),
                      ),
                    ),
                  ),
                ],
